...
from tools.base import ToolResults
...
class AgentEvent:
    ...
    @classmethod
    def agent_end(
        cls, response: str, token_usage: TokenUsage | None = None
    ) -> AgentEvent:
        return cls(
            type=AgentEventType.AGENT_END,
            data={
                "response": response,
                "usage": token_usage.__dict__ if token_usage else None,
            },
        )
    ...
    @classmethod
    def tool_call_complete(cls, call_id: str, name: str, result=ToolResults):
        return cls(
